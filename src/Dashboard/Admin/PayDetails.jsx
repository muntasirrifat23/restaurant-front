...
const PayDetails = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <div className="w-full max-w-7xl px-4 py-6 mt-6">
        ...
        <button onClick={handlePayDeleteAll} className="btn btn-error text-white text-center">Delete All Payment Details</button>
        </div>
